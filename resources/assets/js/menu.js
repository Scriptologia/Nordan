...
//отслеживаем клик вне блока
    ...
    //     // prevArrow: $('.main-slider .prev'),
    //     // nextArrow: $('.main-slider .next'),
    //     appendDots: $('.work-slider_dots'),
    //     dotsClass: 'work-slider_dots_list',
    //     customPaging : function(slider, i) {
    //         return '<div class="dot"></div>';
    //     },
    //     slidesToScroll: 1,
    ...
    //     var currrentNavSlideElem = '.slider-nav .product-slider-main[data-slick-index="' + currentSlide + '"]';
    //     $('.product-slider-nav .product-slider-main.is-active').removeClass('is-active');
    //     $(currrentNavSlideElem).addClass('is-active');
    // });
    //
    // $('.product-slider-nav').on('click', '.product-slider-main', function(event) {
    ...
    //     e.preventDefault();
    //     let benzin = $(this).find('#benzin').val()
    //     let gas = $(this).find('#gas').val()
    //     let rashod = $(this).find('#rashod').val()
    //     let day = $(this).find('#day').val()
    //     let cena = (rashod *  day * (benzin - gas)/100)
    //     $(this).find('.cena').html(cena + ' ₽')
    // })
